...
\[\Psi(r_*) = 0\]
\[w(r_*) = 0\]
Non-dimensional parameter may be something like $\frac{\Gamma}{WR}$ (we can probs relate this to $kr_0$ for the rankine problem)
...
\begin{align*}
    ...
    \dd C\Psi &=\frac{-\Gamma}{2\pi} \dd{}\Psi \left(e^{-r^2/\delta^2}\right)\\
    \dd C\Psi &=\frac{-\Gamma}{2\pi} \dd{}\Psi \left(e^{-2\Psi/W\delta^2}\right)\\
    \dd C\Psi &=\frac{\Gamma}{W\delta^2\pi} \left(e^{-2\Psi/W\delta^2}\right)\\
\end{align*}


\begin{align*}
    H &= \frac12 \left(u^2+v^2 + w^2\right) + \frac{p}{\rho}\\
    &=\frac12 \left(u^2+v^2 + w^2\right) + \int \frac1\rho \dd pr dr\\
    &=\frac12 \left(\left(\frac{\Gamma}{2\pi r} \left(1 - e^{-r^2/\delta^2}\right)\right)^2 + W^2\right) + \int \frac{v^2}{r}dr\\
    &=\frac12 \left(\left(\frac{\Gamma}{2\pi r} \left(1 - e^{-r^2/\delta^2}\right)\right)^2 + W^2\right) + \int \frac{ \frac{\Gamma^2}{4\pi^2r^2} \left(1-e^{-r^2/\delta^2}\right)^2}{r} dr\\
    &=\frac12W^2 + \frac{\Gamma^2}{4\pi^2} \left(\frac{1}{r^2} \left(1 - e^{-r^2/\delta^2}\right)^2 + \int \frac{ \left(1-e^{-r^2/\delta^2}\right)^2}{r^3} dr\right) \\
    &=\frac12W^2 + \frac{\Gamma^2}{4\pi^2} \left(\frac{1}{r^2} \left(1 - 2e^{-r^2/\delta^2} + e^{-2r^2/\delta^2}\right) + \int \frac{1}{r^3} dr +\int \frac{e^{-2r^2/\delta^2}}{r^3} dr - \int \frac{2e^{-r^2/\delta^2}}{r^3} dr\right) \\
    &=\frac12W^2 + \frac{\Gamma^2}{4\pi^2} \left(\frac{1}{r^2} \left(1 - 2e^{-r^2/\delta^2} + e^{-2r^2/\delta^2}\right) -\frac{1}{2r^2} +\int \frac{e^{-2r^2/\delta^2}}{r^3} dr - 2\int \frac{e^{-r^2/\delta^2}}{r^3} dr\right) \\
\end{align*}

Focus on the two integrals:
\begin{align*}
    1: & \int \frac{e^{-2r^2/\delta^2}}{r^3} dr\\
    &\text{integrate by parts} & \left(u = e^{-2r^2/\delta^2}, \ v' = \frac{1}{r^3}\right)\\
    &= -\frac{e^{-2r^2/\delta^2}}{2r^2} - \int \frac{2e^{-2r^2}}{\delta^2r} dr&\left(let \ u = \frac{2r^2}{\delta^2} \implies dr = \frac{\delta^2}{4r}du\right)\\
    &=-\frac{e^{-2r^2/\delta^2}}{2r^2} - \frac{1}{\delta^2}\int \frac{e^{-u}}{u} du\\
    &=-\frac{e^{-2r^2/\delta^2}}{2r^2} - \frac{-E_1(u)}{\delta^2}\\
    &=\frac{E_1(\frac{2r^2}{\delta^2})}{\delta^2} -\frac{e^{-2r^2/\delta^2}}{2r^2} 
\end{align*}
\[= -E_i\left(-2r^2/\delta^2\right)/\delta^2 - \frac{e^{-2r^2/\delta^2}}{2r^2} \]
% using integration by parts 
% \[u = e^{-r^2/\delta^2} \implies u' = \frac{2re^{-r^2/\delta^2}}{\delta^2}\]
% \[v' = \frac{1}{r^3} \implies v = \frac{-1}{2r^2}\]
% \[\int uv' = uv - \int u'v\]
Same process for the second: 
\begin{align*}
    2: &\int\frac{2e^{-r^2/\delta^2}}{r^3} dr\\
     &= -\frac{e^{-r^2/\delta^2}}{r^2} - 2\int \frac{e^{-r^2/\delta^2}}{\delta^2 r} dr\\
    &= -\frac{e^{-r^2/\delta^2}}{r^2} - \frac{1}{\delta^2}\int \frac{-e^{-u}}{u} dr, \quad  u = \frac{r^2}{\delta^2}, \ dr = \frac{\delta^2}{2r}du\\
    &= -\frac{e^{-r^2/\delta^2}}{r^2} - \frac{-E_1\left(r^2/\delta^2\right)}{ \delta^2}\\
    &= \frac{E_1(r^2/\delta^2)}{\delta^2} - \frac{e^{-r^2/\delta^2}}{r^2}
\end{align*}

\[= -E_i\left(-r^2/\delta^2\right)/\delta^2 - \frac{e^{-r^2/\delta^2}}{r^2} \]

Giving

\begin{align*}
    H &= \frac12W^2 + \frac{\Gamma^2}{4\pi^2} \left(\frac{1}{r^2} \left(1 - 2e^{-r^2/\delta^2} + e^{-2r^2/\delta^2}\right) -\frac{1}{2r^2} +\int \frac{e^{-2r^2/\delta^2}}{r^3} dr - \int \frac{2e^{-r^2/\delta^2}}{r^3} dr\right) \\
    &= \frac12W^2 + \frac{\Gamma^2}{4\pi^2} \left(\frac{1}{r^2} \left(1 - 2e^{-r^2/\delta^2} + e^{-2r^2/\delta^2}\right) -\frac{1}{2r^2} + \frac{E_1(\frac{2r^2}{\delta^2})}{\delta^2} -\frac{e^{-2r^2/\delta^2}}{2r^2}  - \frac{E_1(r^2/\delta^2)}{\delta^2} + \frac{e^{-r^2/\delta^2}}{r^2}\right) \\
    &= \frac12W^2 + \frac{\Gamma^2}{4\pi^2} \left(\frac{1}{2r^2} + \frac{E_1(\frac{2r^2}{\delta^2})}{\delta^2} +\frac{e^{-2r^2/\delta^2}}{2r^2}  - \frac{E_1(r^2/\delta^2)}{\delta^2} - \frac{e^{-r^2/\delta^2}}{r^2}\right) \\
    &\text{Or in terms of }\Psi\\
    &=\frac12 W^2 + \frac{\Gamma^2}{4\pi^2}\left(\frac{W}{4\Psi} + \frac{E_1(4\Psi/W\delta^2)}{\delta^2} +\frac{We^{-4\Psi/W\delta^2}}{4\Psi}  - \frac{E_1(2\Psi/W\delta^2)}{\delta^2} - \frac{We^{-2\Psi/W\delta^2}}{2\Psi}\right)\\
\end{align*}

Hence using $r^2 = \frac{2\Psi}{W}$
\begin{align*}
    \dd H\Psi &=  \dd{}\Psi\left(\frac12 W^2 + \frac{\Gamma^2}{4\pi^2}\left(\frac{W}{4\Psi} + \frac{E_1(4\Psi/W\delta^2)}{\delta^2} +\frac{We^{-4\Psi/W\delta^2}}{4\Psi}  - \frac{E_1(2\Psi/W\delta^2)}{\delta^2} - \frac{We^{-2\Psi/W\delta^2}}{2\Psi}\right)\right)\\
    &=\frac{\Gamma^2}{4\pi^2}\dd{}\Psi \left(\frac{W}{4\Psi} + \frac{E_1(4\Psi/W\delta^2)}{\delta^2} +\frac{We^{-4\Psi/W\delta^2}}{4\Psi}  - \frac{E_1(2\Psi/W\delta^2)}{\delta^2} - \frac{We^{-2\Psi/W\delta^2}}{2\Psi}\right)\\
    &=\frac{\Gamma^2}{4\pi^2}\left(-\frac{W}{4\Psi^2} + \frac{e^{4\Psi/ W\delta^2}}{\Psi\delta^2} 
    -\frac{e^{-4\Psi/W\delta^2}}{\Psi\delta^2}  
    - \frac{e^{2\Psi/W\delta^2}}{\Psi\delta^2} 
    - \frac{We^{-2\Psi/W\delta^2}}{2\Psi}\right)\\
\end{align*}

\begin{align*}
    \dd H\Psi &=  \dd{}\Psi\left(\frac12 W^2 + \frac{\Gamma^2}{4\pi^2}\left(\frac{W}{4\Psi} - \frac{E_i(-4\Psi/W\delta^2)}{\delta^2} +\frac{We^{-4\Psi/W\delta^2}}{4\Psi}  + \frac{E_i(-2\Psi/W\delta^2)}{\delta^2} - \frac{We^{-2\Psi/W\delta^2}}{2\Psi}\right)\right)\\
    &=\frac{\Gamma^2}{4\pi^2}\dd{}\Psi \left(\frac{W}{4\Psi} - \frac{E_i(-4\Psi/W\delta^2)}{\delta^2} +\frac{We^{-4\Psi/W\delta^2}}{4\Psi}  + \frac{E_i(-2\Psi/W\delta^2)}{\delta^2} - \frac{We^{-2\Psi/W\delta^2}}{2\Psi}\right)\\
    &=\frac{\Gamma^2}{4\pi^2}\left(-\frac{W}{4\Psi^2} - \frac{e^{-4\Psi/W\delta^2}}{\delta^2\Psi} +\frac{-4e^{-4\Psi/W\delta^2}}{4 \delta\Psi}  + \frac{e^{-2\Psi/W\delta^2}}{\delta^2\Psi} - \frac{-2We^{-2\Psi/W\delta^2}}{2\delta^2\Psi}\right)\\
\end{align*}

Not sure where I have gone wrong but I should get:
\[H = \frac{1}{2} W^2 + \frac{\Gamma^2}{4 \delta^2\pi ^2} \left(E_i\left(\frac{4\psi }{\delta^2W}\right)-E_i\left(\frac{2\psi }{ \delta ^2W}\right)\right)  \]

\[\odd H \Psi = \frac{\Gamma^2}{4 \delta^2 \Psi  \pi ^2} \left(e^{-\frac{4 \Psi }{\delta^2 W}} -e^{-\frac{2 \Psi }{\delta^2 W}}\right)\]

\[\ddn\Psi r2 - \frac1r \dd\Psi r = r^2 \odd H\Psi - C \odd C\Psi\]
\[\ddn{\Psi}r2  -\frac{1}{r}\dd\Psi r =\frac{\Gamma^2}{2\delta^2 W \pi^2} \left(e^{-\frac{r^2}{\delta^2}} \left(e^{-\frac{r^2}{\delta^2}}-1\right)+ e^{-\frac{2 r^2}{\delta^2}} \left(e^{\frac{r^2}{\delta^2}}-1\right)\right)\]

\verb|dsolve()| gives
\[\Psi(r) = ar^2 + b\]

%apparently its `quasilinear'
...
\[\begin{pmatrix}
    ...
    r_*
\end{pmatrix}\]
This will be a non-linear problem so we will need to solve using fsolve.

...
\[r = \eta(R-r_*)) +r_*\]
DE becomes
\[\frac{1}{(R-r_*)^2}\ddn{\Psi}\eta2  -\frac{1}{\eta(R-r_*)) +r_*} \frac1{R-r_*}\dd\Psi \eta =\frac{\Gamma^2}{2\delta^2 W \pi^2} \left(e^{-\frac{(\eta(R-r_*)) +r_*)^2}{\delta^2}} \left(e^{-\frac{(\eta(R-r_*)) +r_*)^2}{\delta^2}}-1\right)+ e^{-\frac{2 (\eta(R-r_*)) +r_*)^2}{\delta^2}} \left(e^{\frac{(\eta(R-r_*)) +r_*)^2}{\delta^2}}-1\right)\right)\]

...
\end{pmatrix} = \frac{1}{det}\begin{pmatrix}
     \hat{r} Y_1(k\hat{r})& -Y_1(kr_*)\\
    -\hat{r} J_1(k\hat{r}) & J_1(kr_*)\\
\end{pmatrix}\begin{pmatrix}
    - \frac12 Wr_*\\
    \frac12 W (r_0^2 - \hat{r}^2)
\end{pmatrix}\]
...
\begin{align*}
    A &= \frac{1}{\det} \left(\hat{r} Y_1(k\hat{r})\left(-\frac12 Wr_*\right) - Y_1(kr_*) \left(\frac12 W(r_0^2 - \hat{r}^2)\right)\right)\\
    B &= \frac{1}{\det} \left(-\hat{r}J_1\left(-\frac12 Wr_*\right) + J_1(kr_*) \left(\frac12 W(r_0^2 - \hat{r}^2)\right)\right)
\end{align*}

Where

\begin{align*}
\det &= \hat{r} Y_1(k\hat{r})J_1(kr_*) - \hat{r} J_1(k\hat{r}) Y_1(kr_*)\\
&= \hat{r}\left(Y_1(k\hat{r})J_1(kr_*) -  J_1(k\hat{r}) Y_1(kr_*)\right)
\end{align*}

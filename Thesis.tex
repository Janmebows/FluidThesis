...
Talk about how vortex breakdown is studied a lot and how we're reproduced results, differences, agreement.

\subsection{An Introduction to Fluid Dynamics}
Bachelor.

Best place to start - really goes to the basics and has derivations for the squire-longe equation as well as some examples, analytic solutions.
...
Uses a strange syntax, particularly using $\xi$ as the vorticity.

...
\[-\dd wr = \frac{1}{r^2} \dd\Psi r - \frac1r \ddn\Psi r2 \]
\begin{align*}
    ...
    \eta|_{z=0} &\approx  \frac{1}{r^2} \left(\frac{\Psi_{i+1,1} - \Psi_{i-1,1}}{\Delta r}\right) - \frac{1}{r} \left(\frac{\Psi_{i+1,1} - 2 \Psi_{i,1} + \Psi_{i-1,1}}{\Delta r^2}\right)
\end{align*}
...
\begin{align*}
    \Psi = f(R)\\
    v = g(R)\\
    \eta = - \dd wr  = \frac{1}{R^2} \Psi'(R,z) - \frac1R \Psi''(R,z)
\end{align*}
...
On the wall $r=R$
\[\eta = \dd uz - \dd wr = - \dd wr = -\dd{}{r}\left(\frac1r \dd \Psi r\right) = \frac1{r^2} \dd \Psi r - \frac1r \ddn \Psi r 2\]
He claims 
